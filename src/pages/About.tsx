      ...
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="mx-auto max-w-3xl">
            <h2 className="font-serif text-3xl font-bold text-foreground text-center">Over the years, we have expanded our facilities, enhanced our curriculum, and welcomed dedicated educators who share our commitment to nurturing young minds. Our graduates have gone on to achieve remarkable success.</h2>
